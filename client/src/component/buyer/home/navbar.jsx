...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-col z-10 fixed  h-[5rem] w-full bg-[#ffff]">

      <div className="w-full bg-[#f1f2f2] p-[5px] h-[30px] text-right pl-[2rem]  pt-[5px] text-xs flex justify-start items-center ml-0">
      ...
      <div className="flex pb-[5px]">
        ...
        >
          ...
          <a href="/" aria-label="home">
            <b>
              <i>
                <h4 className="" aria-label="name">E-Commerce</h4>
              </i>
            </b>
          </a>
        </div>
