...
const Sidebar = () => {
    ...
    return (
        <div className="w-[17%] bg-[#FFFF] h-screen mt-[4rem] pl-[2rem] pt-[1rem] flex flex-col pr-[2rem]  ">
            <div className="w-full ">
                <button type="button" className="flex justify-between  items-center gap-2 hover:bg-gray-100 rounded-lg p-1" onClick={handleDropdown}>
