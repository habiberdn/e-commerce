                    ...
                    <div className="relative group mr-[1rem]  ">
                        ...
                        >
                            ...
                            {isOpen &&
                                ...
                                >
                                       <li className='flex p-1 hover:bg-gray-100'>
                                        <svg xmlns="http://www.w3.org/2000/svg" className='w-[2rem]' viewBox="0 0 24 24"><path d="M12 1L21.5 6.5V17.5L12 23L2.5 17.5V6.5L12 1ZM12 3.311L4.5 7.65311V16.3469L12 20.689L19.5 16.3469V7.65311L12 3.311ZM12 16C9.79086 16 8 14.2091 8 12C8 9.79086 9.79086 8 12 8C14.2091 8 16 9.79086 16 12C16 14.2091 14.2091 16 12 16ZM12 14C13.1046 14 14 13.1046 14 12C14 10.8954 13.1046 10 12 10C10.8954 10 10 10.8954 10 12C10 13.1046 10.8954 14 12 14Z" fill="currentColor"></path></svg>
                                        <button className='text-right w-full justify-end  active:bg-blue-100  cursor-pointer rounded-md p-2  flex items-center'  >
                                            Settings
                                        </button>
                                    </li>
                                    <li className='flex p-1 hover:bg-gray-100'>
                                        <svg xmlns="http://www.w3.org/2000/svg" className='w-[2rem]' viewBox="0 0 24 24"><path d="M4 18H6V20H18V4H6V6H4V3C4 2.44772 4.44772 2 5 2H19C19.5523 2 20 2.44772 20 3V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V18ZM6 11H13V13H6V16L1 12L6 8V11Z" fill="rgba(255,0,0,1)"></path></svg>
