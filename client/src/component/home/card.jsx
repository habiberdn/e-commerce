...
export default function Card(props) {
  ...
  return (
    <div className="rounded-lg mt-1 ">
      <div className="relative w-[10rem] h-[16rem] flex flex-col flex-start rounded-lg">
        <a href=" ">
          ...
          <div className="grid gap-y-1">
            ...
            <h6 className="flex text-left w-full h-[59px] text-ellipsis overflow-hidden  ">{props.description}</h6>
          </div>
          <div className="absolute flex justify-between inset-x-0 bottom-0 ">
            <h6 className=""><b>${props.price}</b></h6>
            <h6>
              <div className="flex w-[30px] justify-between ">
              <svg className="w-[15px]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
